...
if AMP_ENABLED:
    ...
    from evennia.portal import amp_server
...
if TELNET_ENABLED:
    ...
    from evennia.portal import telnet
...
if SSL_ENABLED:
    ...
    from evennia.portal import telnet_ssl
...
if SSH_ENABLED:
    ...
    from evennia.portal import ssh
    ...
    for interface in WEBSERVER_INTERFACES:
        ...
        for proxyport, serverport in WEBSERVER_PORTS:
            ...
            if WEBCLIENT_ENABLED:
                ...
                from evennia.portal import webclient_ajax
