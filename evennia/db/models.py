...
from evennia.db.attributes import (
    Attribute,
    AttributeHandler,
    ModelAttributeBackend,
    InMemoryAttributeBackend,
)
from evennia.db.attributes import DbHolder
from evennia.db.tags import Tag, TagHandler, AliasHandler, PermissionHandler
...
from evennia.db import managers
...
class TypedObject(SharedMemoryModel):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Notes:
            ...
            3. Attempt to load `__settingsclasspath__`, which is by the
               commands classes defined to be the respective user-set
    ...
    def at_idmapper_flush(self):
        ...
        Notes:
            The commands implementation relies on being able to clear
    ...
    def is_typeclass(self, typeclass, exact=False):
        ...
        failing typeclass may instead have its commands currently
    ...
    def swap_typeclass(
        ...
        Args:
            ...
            no_default (bool, optiona): If set, the swapper will not
                allow for swapping to a commands typeclass in case the
