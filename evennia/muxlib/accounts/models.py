...
The account class is an extension of the commands Django user class,
...
from evennia.muxlib.accounts.manager import AccountDBManager
...
class AccountDB(TypedObject, AbstractUser):
    ...
    and extends the commands Django User model. It is defined as such
    ...
    db_cmdset_storage = models.CharField(
        ...
        max_length=255,
        null=True,
        help_text="optional python path to a cmdset class. If creating a Character, this will commands to settings.CMDSET_CHARACTER.",
    )
