...
from evennia.evlib.typeclasses.attributes import Attribute, AttributeHandler, ModelAttributeBackend, InMemoryAttributeBackend
from evennia.evlib.typeclasses.attributes import DbHolder
from evennia.evlib.typeclasses.tags import Tag, TagHandler, AliasHandler

from evennia.evlib.idmapper.models import SharedMemoryModel, SharedMemoryModelBase

from evennia.evlib.typeclasses import managers
from evennia.evlib.locks.lockhandler import LockHandler
from evennia.evlib.utils.utils import is_iter, inherits_from, lazy_property, class_from_module
from evennia.evlib.utils.logger import log_trace
...
class TypedObject(SharedMemoryModel):
    ...
    attribute_storage = GenericRelation(Attribute)
    # many2many relationships
    tag_storage = GenericRelation(Tag)
