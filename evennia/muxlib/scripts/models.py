...
- Load the commands cmdset to the account object's cmdhandler
  when logging in.
- Switch to a different state, such as entering a text editor,
  start combat or enter a dark room.
- Merge a new cmdset with the commands one for changing which
...
from evennia.muxlib.scripts.manager import ScriptDBManager
