...
from evennia.db.tags import Tag, TagHandler
from evennia.utils.idmapper.models import SharedMemoryModel
from evennia.muxlib.comms import managers
...
class SubscriptionHandler(object):
    ...
    def add(self, entity):
        ...
        if not _CHANNELHANDLER:
            from evennia.muxlib.comms import CHANNEL_HANDLER as _CHANNELHANDLER
