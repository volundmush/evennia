...
from evennia.evlib.portal.protocols.telnet import ttype, mssp, telnet_oob, naws, suppress_ga
from evennia.evlib.portal.protocols.telnet.mccp import Mccp, mccp_compress, MCCP
from evennia.evlib.portal.protocols.telnet.mxp import Mxp, mxp_parse
from evennia.evlib.utils import ansi
from evennia.evlib.utils.utils import to_bytes, class_from_module
...
class TelnetProtocol(Telnet, StatefulTelnetProtocol, _BASE_SESSION_CLASS):
    ...
    def connectionMade(self):
        ...
        from evennia.evlib.utils.utils import delay
    ...
    def disableLocal(self, option):
        ...
        if option == MCCP:
            ...
            try:
                ...
                from evennia.evlib.utils import logger
