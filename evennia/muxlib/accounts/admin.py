...
from evennia.db.admin import AttributeInline, TagInline
...
class AccountForm(forms.ModelForm):
    ...
    db_permissions = forms.CharField(
        ...
        "Normal accounts use 'Accounts' by commands.",
    )
    ...
    db_cmdset_storage = forms.CharField(
        ...
        "settings.CMDSET_ACCOUNT by commands)",
    )
    ...
    fieldsets = (
        ...
        (
            "Website profile",
            {
                ...
                "description": "<i>These are not used " "in the commands system.</i>",
            },
        ),
        (
            "Website dates",
