...
from evennia.muxlib.commands import CharacterCmdSet
from evennia.utils.test_resources import EvenniaTest
from evennia.muxlib.commands import (
    help,
    general,
    system,
    admin,
...
class TestBuilding(CommandTest):
    ...
    def test_typeclass(self):
        ...
        self.call(building.CmdTypeclass(), "/list Obj", "Core db")
        self.call(
            building.CmdTypeclass(),
            "/show Obj",
        ...
        from evennia.muxlib.prototypes import homogenize_prototype
