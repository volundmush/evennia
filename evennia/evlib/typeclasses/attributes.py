...
from evennia.evlib.idmapper.models import SharedMemoryModel
from evennia.evlib.utils.dbserialize import to_pickle, from_pickle
from evennia.evlib.utils.picklefield import PickledObjectField
from evennia.evlib.utils.utils import lazy_property, to_str, make_iter, is_iter
...
class Attribute(IAttribute, SharedMemoryModel):
    ...
    class Meta(object):
        ...
        unique_together = (('db_model', 'db_object_id', 'db_attrtype', 'db_category', 'db_key'))
...
class ModelAttributeBackend(IAttributeBackend):
    ...
    def __init__(self, handler, attrtype):
        ...
        self._storage = self._model.attribute_storage
    ...
    def query_key(self, key, category):
        ...
        if not self.obj.pk:
            return []
        return self._storage.filter(**query)
    ...
    def do_create_attribute(self, key, category, lockstring, value, strvalue):
        ...
        new_attr = self._storage.create(**kwargs)
        new_attr.save()
