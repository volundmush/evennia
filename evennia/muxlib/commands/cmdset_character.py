"""
This module ties together all the commands commands Character objects have
...
from evennia.muxlib.commands import general, help, admin, system
...
class CharacterCmdSet(CmdSet):
    """
    Implements the commands command set.
    """
